#include "../include/GoldrenSection.h"
...
void GoldrenSection::pass()
	{
		...
		std::cout <<std::left<<"\nÌåòîä çîëîòîãî ñå÷åíèÿ\n"
			...
			<< std::setw(13) << "" << "|" << std::setw(10) << "Äëèíà" << "||" << std::setw(6) << "" << "|" << std::setw(6) << "" << "||" << std::setw(6) << "" << "|" << std::setw(6) << "" << "|\n"
			<< std::setw(13) << "Èíòåðâàë" << "|" << std::setw(10) << "èíòåðâàëà" << "||" << std::setw(6) << "X1" << "|" << std::setw(6) << "X2" << "||" << std::setw(6) << "F(X1)" << "|" << std::setw(6) << "F(X2)" << "|\n"
		...
		std::cout << "_______________________________________________________\n"
			<<"Ðåçóëüòàò: " << bottom_edge + (top_edge - bottom_edge) / 2 << "\n"
			<< "x* ïðèíàäëåæèò [ " << bottom_edge << " , " << top_edge << " ] " << "\n"
			<< "--------------------------\n";;
